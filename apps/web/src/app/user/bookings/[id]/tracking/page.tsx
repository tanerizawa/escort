      ...
      {tracking && (
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Card>
              <CardHeader>
                <h2 className="text-sm font-semibold text-white"><MapPin className="h-4 w-4 inline-block mr-1" /> Lokasi Client</h2>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <h2 className="text-sm font-semibold text-white"><MapPin className="h-4 w-4 inline-block mr-1" /> Lokasi Escort</h2>
              </CardHeader>
              <CardContent>

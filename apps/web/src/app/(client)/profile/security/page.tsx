        ...
        <CardContent>
          ...
          {setupMode && (
            <div className="space-y-6">
              {/* Step 1: Show QR Code / Secret */}
              <div className="space-y-3">
                <h3 className="text-white font-medium">Langkah 1: Scan QR Code</h3>
                <p className="text-gray-400 text-sm">
                  Scan QR code di bawah menggunakan aplikasi autentikator, atau masukkan kode manual:
                </p>
              ...
              {/* Step 2: Verify */}
              <div className="space-y-3">
                <h3 className="text-white font-medium">Langkah 2: Verifikasi</h3>
                <p className="text-gray-400 text-sm">

  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#0b1120', color: '#f5f5f5', fontFamily: 'system-ui' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <a href="/" style={{ display: 'inline-block', marginTop: 24, padding: '10px 32px', border: '1px solid rgba(201,169,110,0.4)', color: '#c9a96e', textDecoration: 'none', fontSize: 11, letterSpacing: 2, textTransform: 'uppercase' }}>
          Kembali ke Beranda
        </a>
      </div>
    </div>

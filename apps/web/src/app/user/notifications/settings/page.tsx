...
const CHANNEL_OPTIONS = [
  { key: 'inApp', label: 'In-App Notification', description: 'Notifikasi di dalam aplikasi', icon: 'Bell' },
  { key: 'email', label: 'Email', description: 'Kirim notifikasi ke email Anda', icon: 'Mail' },
  { key: 'push', label: 'Push Notification', description: 'Notifikasi browser/mobile', icon: 'Smartphone' },
  { key: 'whatsapp', label: 'WhatsApp', description: 'Notifikasi via WhatsApp', icon: 'MessageCircle' },
];
    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="mt-8">
        <WizardShell totalSteps={2}>
          <StepIndicator labels={['Channel', 'Tipe Notifikasi']} />
          ...
          <WizardStep step={0}>
            <div className="text-center mb-6">
              ...
              <h3 className="text-lg font-light text-dark-100">Channel Notifikasi</h3>
              <p className="mt-1 text-sm text-dark-400">Pilih media untuk menerima notifikasi</p>
            </div>
              ...
              {CHANNEL_OPTIONS.map((channel) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="text-xl"><Icon name={channel.icon} className="h-5 w-5 text-brand-400" /></span>
                    <div>
          ...
          <WizardStep step={1}>
            <div className="text-center mb-6">
              ...
              <h3 className="text-lg font-light text-dark-100">Tipe Notifikasi</h3>
              <p className="mt-1 text-sm text-dark-400">Pilih jenis notifikasi yang ingin Anda terima</p>
            </div>
            ...
            <WizardNavigation nextLabel="Selesai" onNext={() => { window.history.back(); return false; }} />
          </WizardStep>
        </WizardShell>
      </div>
